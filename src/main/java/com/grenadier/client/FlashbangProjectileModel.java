...
public final class FlashbangProjectileModel extends HierarchicalModel<FlashbangProjectile> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("armsrace", "flashbang_projectile"),
            "main"
    );
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        ...
                        .texOffs(32, 8).addBox(-3.0F, -8.0F, -2.5F, 6.0F, 2.0F, 5.0F)
                        .texOffs(32, 17).addBox(3.65F, -6.0F, -2.4F, 1.0F, 8.0F, 2.0F)
                        .texOffs(40, 29).addBox(3.45F, -6.5F, -3.25F, 1.0F, 1.0F, 1.0F),
                PartPose.ZERO
        );
