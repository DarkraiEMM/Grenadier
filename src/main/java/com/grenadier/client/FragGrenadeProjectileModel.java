...
public final class FragGrenadeProjectileModel extends HierarchicalModel<FragGrenadeProjectile> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            GrenadierMod.path("frag_grenade_projectile"),
            "main"
    );
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(0, 0).addBox(-4.5F, -4.0F, -3.5F, 9.0F, 8.0F, 7.0F)
                        .texOffs(0, 18).addBox(-3.5F, 4.0F, -3.0F, 7.0F, 2.0F, 6.0F)
                        .texOffs(32, 0).addBox(-3.5F, -6.0F, -3.0F, 7.0F, 2.0F, 6.0F)
                        .texOffs(32, 8).addBox(-2.0F, -8.0F, -2.0F, 4.0F, 2.0F, 4.0F)
                        .texOffs(32, 16).addBox(3.65F, -6.0F, -2.4F, 1.0F, 7.0F, 2.0F)
